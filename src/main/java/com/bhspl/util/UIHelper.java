...
public class UIHelper {
    ...
    public static boolean confirm(Component parent, String title, String message) {
        JDialog dlg = new JDialog(parent instanceof Window ? (Window)parent : null, title, Dialog.ModalityType.APPLICATION_MODAL);
        ...
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            ...
            public Component getTableCellRendererComponent(JTable t, Object val, boolean sel, boolean focus, int row, int col) {
                ...
                if (t.getColumnName(col).toLowerCase().contains("status")) {
                    if (s.equalsIgnoreCase("Present") || s.equalsIgnoreCase("Active") || s.equalsIgnoreCase("Success")) {
                        setForeground(SUCCESS);
                        setFont(new Font("Segoe UI", Font.BOLD, 14));
                    } else if (s.equalsIgnoreCase("Absent") || s.equalsIgnoreCase("Inactive") || s.equalsIgnoreCase("Error") || s.equalsIgnoreCase("Late")) {
    ...
    public static Color symBg(String sym) {
        switch (sym == null ? "" : sym) {
            case "P":   return new Color(0xDCFCE7); // Emerald 100
            case "A":   return new Color(0xFEE2E2); // Rose 100
            case "HD":  return new Color(0xFEF3C7); // Amber 100
            case "CL":  case "SL": case "EL": return new Color(0xE0E7FF); // Indigo 100
            case "WO":  case "PH": return new Color(0xF1F5F9); // Slate 100
            default:    return new Color(0xF1F5F9);
        }
    }

    public static Color symFg(String sym) {
        switch (sym == null ? "" : sym) {
            case "P":   return new Color(0x065F46);
            case "A":   return new Color(0x991B1B);
            case "HD":  return new Color(0x92400E);
            case "CL":  case "SL": case "EL": return new Color(0x3730A3);
            case "WO":  case "PH": return new Color(0x475569);
            default:    return new Color(0x475569);
        }
    }
