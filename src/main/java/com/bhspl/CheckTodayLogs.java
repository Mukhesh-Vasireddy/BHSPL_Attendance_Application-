...
public class CheckTodayLogs {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("Checking for raw_logs from 2026-04-23...");
            List<Map<String, Object>> logs = db.query("SELECT * FROM raw_logs WHERE punch_time LIKE '2026-04-23%'");
            System.out.println("Found " + logs.size() + " logs for today.");
